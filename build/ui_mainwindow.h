...
public:
    ...
    centralwidget->setGeometry(QRect(0, 33, 900, 553));
    ...
    gridLayout->addWidget(setAnimationTimeButton, 1, 6, 1, 1);
    ...
    statusbar->setGeometry(QRect(0, 586, 900, 19));
